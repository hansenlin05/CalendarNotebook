...
## *Proposal*
The application is a Java-based application of the calendar notebook, calendar notepad with basic browsing and date modification functions . The notepad has basic functions such as input, save, delete, view and so on.
...
- As a **user**, I want to want to be able to delete logs for a certain date As a user, I want the log to be saved as a local file 
